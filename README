 ...
 * Website: https://github.com/bskyb-commerce/juxtapose
 * Source: https://github.com/bskyb-commerce/juxtapose

Juxtapose is a screenshot comparison tool, created by David Rooks at BSKYB.
